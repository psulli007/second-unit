...
const brand = {
  ...
  // Optional wordmark shown on intro/outro cards. Path relative to the repo root or
  // absolute; the card renderer inlines it, so it never needs to be web-reachable.
  logo: cfg.BRAND_LOGO || null,
  logoH: cfg.BRAND_LOGO_HEIGHT || null,
};
